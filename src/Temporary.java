 ...
 *  QUESTION: #5
 *
 *  PURPOSE: A classical game --minesweeper. r. The player clicks on cells in a rectangular
grid, to uncover the contents of the cells. The goal is to uncover all cells that do not contain "mines".
Cells that are next to mines display a number indicatng the number of neighbouring cells that contain
mines. The player uses those numbers to decide where mines are located.
 */
